...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM cpf

#if !defined(_TRACE_CPF_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_CPF_H
...
#define __PROG_TYPE_TP_FN(x)	\
	TRACE_DEFINE_ENUM(CPF_PROG_TYPE_##x);
...
#define __MAP_TYPE_TP_FN(x)	\
	TRACE_DEFINE_ENUM(CPF_MAP_TYPE_##x);
...
DECLARE_EVENT_CLASS(cpf_prog_event,

	TP_PROTO(const struct cpf_prog *prg),
...
DEFINE_EVENT(cpf_prog_event, cpf_prog_get_type,
...
DEFINE_EVENT(cpf_prog_event, cpf_prog_put_rcu,
...
TRACE_EVENT(cpf_prog_load,

	TP_PROTO(const struct cpf_prog *prg, int ufd),
...
TRACE_EVENT(cpf_map_create,

	TP_PROTO(const struct cpf_map *map, int ufd),
...
DECLARE_EVENT_CLASS(cpf_obj_prog,
...
DEFINE_EVENT(cpf_obj_prog, cpf_obj_pin_prog,
...
DEFINE_EVENT(cpf_obj_prog, cpf_obj_get_prog,
...
DECLARE_EVENT_CLASS(cpf_obj_map,
...
DEFINE_EVENT(cpf_obj_map, cpf_obj_pin_map,
...
DEFINE_EVENT(cpf_obj_map, cpf_obj_get_map,
...
DECLARE_EVENT_CLASS(cpf_map_keyval,
...
DEFINE_EVENT(cpf_map_keyval, cpf_map_lookup_elem,
...
DEFINE_EVENT(cpf_map_keyval, cpf_map_update_elem,
...
TRACE_EVENT(cpf_map_delete_elem,
