...
http.createServer((req, res) => {
  ...
  // To print the flag we need the the secret makeId which is used as blueprintId storing the flag.
  // Then we can directly access the blueprintId to check the flag.
