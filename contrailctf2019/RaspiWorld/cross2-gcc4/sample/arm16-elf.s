...
@ options passed:  -nostdinc -D__USES_INITFINI__ arm16-elf.c -mthumb
...
.LVL34:
	ldr	r3, .L48	@ tmp138,
	str	r0, [r3]	@ static_value.0, static_value
	.loc 1 180 0
	mov	r0, r4	@, b
	@ sp needed for prologue	@
.LVL35:
...
.LVL49:
	ldr	r3, [sp, #4]	@, a5
.LVL50:
	add	r0, r0, r3	@ tmp148, tmp147,
	ldr	r3, [sp, #12]	@, a7
	add	r0, r0, r3	@ tmp146, tmp148,
	.loc 1 206 0
	@ sp needed for prologue	@
	bx	lr
	.cfi_endproc
