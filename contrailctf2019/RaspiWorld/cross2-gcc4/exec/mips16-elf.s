 ...
 # mips16-elf.c -mips16 -mno-synci -auxbase-strip mips16-elf.s -g -O -Wall
...
$LVL12 = .
	...
	addiu	$16,1	 # str,
$LVL13 = .
	lb	$5,0($16)	 # D.1060, MEM[base: str_7, offset: 0B]
	bnez	$5,$L9	 #, D.1060,
$L8:
	.loc 1 50 0
	li	$2,0	 #,
...
$LVL17 = .
	...
	li	$2,0	 # tmp207,
	move	$3,$sp	 #,
	sb	$2,32($3)	 # tmp207, MEM[(char *)&buf + 16B]
$LVL18 = .
	.loc 1 90 0
	bnez	$5,$L12	 #, value,
...
$L15:
	...
	li	$3,15	 # tmp209,
$LVL21 = .
	and	$3,$5	 # tmp210, value
	lw	$7,$L22	 # tmp208,
	addu	$3,$7,$3	 # tmp211, tmp208, tmp210
	lbu	$3,0($3)	 #,
	sb	$3,1($2)	 #, MEM[base: D.1095_24, offset: 1B]
$LVL22 = .
	.loc 1 95 0
...
$LVL27 = .
	...
	li	$3,48	 # tmp215,
$LVL28 = .
	sb	$3,1($2)	 # tmp215, MEM[base: D.1096_5, offset: 1B]
$LVL29 = .
	b	$L17	 #
$LVL30 = .
$L20:
