...
.method public onClick(Landroid/view/View;)V
    ...
    move-object/from16 v1, p0 # v1 = view;
    ...
    :goto_0
    # v2 = new Object[0x31]; // new Object[49]
    ...
    aput-object v8, v2, v3 # obj_arr[0] = Integer.valueOf(0x41);
    ...
    aput-object v5, v2, v3
    # dummy flag ends here

    .line 49
    .local v2, "key":[Ljava/lang/Object; # Ojbect key; // v2
    new-instance v3, Ljava/lang/StringBuilder; v3 = StringBuilder();

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    .line 50
    .local v3, "keyString":Ljava/lang/StringBuilder; # StringBuilder keyString; // v3
    array-length v5, v2 # v5 = key.length(); // the array of Object used to store chars

    const/4 v6, 0x0 # v6 seems to be a loop counter

    :goto_1
    if-ge v6, v5, :cond_0 # if (v6_loop_counter >= key.length()) goto cond_0

    aget-object v8, v2, v6 # v8 = obj_arr[v6_loop_counter];
    ...
    move-result v9 # v9 = obj_arr[v6_loop_counter].charValue();

    # keyString.append(obj_arr[v6_loop_counter].charValue();
    invoke-virtual {v3, v9}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;

    .line 50
    .end local v8    # "chr":Ljava/lang/Object;
    add-int/lit8 v6, v6, 0x1 # increment loop_counter
    ...
    move-result v5 # v5 = flagString.length();

    const/16 v6, 0x30

    if-eq v5, v6, :cond_2 # if (flagString.length() == v6) goto cond_2;
    ...
    move-result v6 # v6 = flagString.length();

    div-int/2addr v6, v7 # v6 = flagString.length() / 0x4; // v7 = 0x4;

    if-ge v5, v6, :cond_3 # if (v5_i >= v6) goto cond_3;

    .line 66
    # v6 references `o` which is the outermost encoling class for `o$1`
